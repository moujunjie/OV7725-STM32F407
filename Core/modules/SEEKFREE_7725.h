...
#define OV7725_W                160                             //定义摄像头图像宽度	可选参数:80 160 240 320
#define OV7725_H                120                             //定义摄像头图像高度	可选参数:60 120 180 240
#define OV7725_SIZE             (OV7725_W * OV7725_H/8 )        //图像占用空间大小
#define OV7725_DMA_NUM          (OV7725_SIZE )                  //DMA采集次数

extern uint8_t image_bin[OV7725_SIZE];                          //定义存储接收图像的数组
extern uint8_t ov7725_finish_flag;								//图像采集完成标志位
